...
public class TbaoUtils {
    ...
    static DefaultTaobaoClient client = new DefaultTaobaoClient("https://eco.taobao.com/router/rest", "111", "11");
    static final String sessionKey = "11";
    static final String sessionKey1 = "11";
